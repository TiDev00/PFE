...
export class CommandComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.commandService
      ...
      .subscribe(
        (res: HttpResponse<ICommand[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCommands(): void {
    this.eventSubscriber = this.eventManager.subscribe('commandListModification', () => this.loadPage());
  }
