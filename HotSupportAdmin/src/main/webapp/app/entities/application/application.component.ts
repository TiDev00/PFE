...
export class ApplicationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.applicationService
      ...
      .subscribe(
        (res: HttpResponse<IApplication[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IApplication[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
