...
import sn.sonatel.dsi.eai.config.audit.AuditEventConverter;
import sn.sonatel.dsi.eai.domain.PersistentAuditEvent;
...
import static sn.sonatel.dsi.eai.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
