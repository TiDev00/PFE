...
describe('Service Tests', () => {
  describe('Server Service', () => {
    ...
    let expectedResult: IServer | IServer[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Server(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Server', () => {
        ...
        service.create(new Server()).subscribe(resp => (expectedResult = resp.body));
